...
function Mine() {
    ...
    if (inventory[selectedSlot] != null) {
        tool = inventory[selectedSlot].block;
    } else {
        tool = null;
    }
...
function Mining() {
    ...
    if (inventory[selectedSlot] != null) {
        if (inventory[selectedSlot].block == Wooden_Pickaxe) {
        ...
        } else if (inventory[selectedSlot].block == Wooden_Axe) {
        ...
        } else if (inventory[selectedSlot].block == Wooden_Shovel) {
        ...
        } else if (inventory[selectedSlot].block == Stone_Pickaxe) {
        ...
        } else if (inventory[selectedSlot].block == Stone_Axe) {
        ...
        } else if (inventory[selectedSlot].block == Stone_Shovel) {
        ...
        } else if (inventory[selectedSlot].block == Iron_Pickaxe) {
        ...
        } else if (inventory[selectedSlot].block == Iron_Axe) {
        ...
        } else if (inventory[selectedSlot].block == Iron_Shovel) {
        ...
        } else if (inventory[selectedSlot].block == Diamond_Pickaxe) {
            if (block == Stone)  { blockDamage += 7.5/0.4; }
        ...
        } else if (inventory[selectedSlot].block == Diamond_Axe) {
        ...
        } else if (inventory[selectedSlot].block == Diamond_Shovel) {
            if (block == Grass) { blockDamage += 0.9/0.15 }
            else if (block == Dirt || block == Sand) { blockDamage += 0.75/0.1 } 
            else if (block == Gravel) { blockDamage += 0.9/0.15 }
            else { blockDamage += 1 }
        } else if (inventory[selectedSlot].block == Golden_Pickaxe) {
            if (block == Stone)  { blockDamage += 7.5/0.4; }
        ...
        } else if (inventory[selectedSlot].block == Golden_Axe) {
        ...
        } else if (inventory[selectedSlot].block == Golden_Shovel) {
