...
var Spruce_Planks = new Block(5.1, 'Images/Items/Spruce_Planks.png', 'block', 3, [0,0, 0,17.1, 4], [0,0,0, 0,17.1,0, 0,0,0, 4], [false, null]);
var Sand = new Block(12, 'Images/Items/Sand.png', 'block', 0.75, null, null, [false, null]);
var Gravel = new Block(13, 'Images/Items/Gravel.png', 'block', 0.6, null, null, [false, null]);
...
var Spruce_Wood = new Block(17.1, 'Images/Items/Spruce_Wood.png', 'block', 3, null, null, [false, null]);
var Oak_Leaves = new Block(18, 'Images/Items/Oak_Leaves.png', 'block', 0.35, null, null, [false, null]);
var Spruce_Leaves = new Block(18.1, 'Images/Items/Spruce_Leaves.png', 'block', 0.35, null, null, [false, null]);
var Lapis_Ore = new Block(21, 'Images/Items/Lapis_Ore.png', 'block', 15, null, null, [true, 351.4]);
var Lapis_Block = new Block(22, 'Images/Items/Lapis_Block.png', 'block', 15, null, [351.4,351.4,351.4, 351.4,351.4,351.4, 351.4,351.4,351.4, 1], [false, null]);
var Sandstone = new Block(24, 'Images/Items/Sandstone.png', 'block', 4, [12,12, 12,12, 1], [0,0,0, 0,12,12, 0,12,12, 1], [false, null]);
var Gold_Block = new Block(41, 'Images/Items/Gold_Block.png', 'block', 15, null, [266,266,266, 266,266,266, 266,266,266, 1], [false, null]);
var Iron_Block = new Block(42, 'Images/Items/Iron_Block.png', 'block', 25, null, [265,265,265, 265,265,265, 265,265,265, 1], [false, null]);
var Diamond_Ore = new Block(56, 'Images/Items/Diamond_Ore.png', 'block', 15, null, null, [true, 264]);
var Diamond_Block = new Block(57, 'Images/Items/Diamond_Block.png', 'block', 25, null, [264,264,264, 264,264,264, 264,264,264, 1], [false, null]);
...
var Ladder = new Block(65, 'Images/Items/Ladder.png', 'block', 0.65, null, [280,0,280, 280,280,280, 280,0,280, 3], [false, null]);
...
var Emerald_Block = new Block(133, 'Images/Items/Emerald_Block.png', 'block', 25, null, [388,388,388, 388,388,388, 388,388,388, 1], [false, null]);
var Redstone_Block = new Block(152, 'Images/Items/Redstone_Block.png', 'block', 25, null, [331,331,331, 331,331,331, 331,331,331, 1], [false, null]);
var Coal_Block = new Block(173, 'Images/Items/Coal_Block.png', 'block', 25, null, [263,263,263, 263,263,263, 263,263,263, 1], [false, null]);
...
var Coal = new Block(263, 'Images/Items/Coal.png', 'tool', null, [0,0, 0,173, 9], [0,0,0, 0173,0, 0,0,0, 9], [false, null]);
var Diamond = new Block(264, 'Images/Items/Diamond.png', 'tool', null, [0,0, 0,57, 9], [0,0,0, 0,57,0, 0,0,0, 9], [false, null])
var Iron = new Block(265, 'Images/Items/Iron.png', 'tool', null, [0,0, 0,42, 9], [0,0,0, 0,42,0, 0,0,0, 9], [false, null]);
var Gold = new Block(266, 'Images/Items/Gold.png', 'tool', null, [0,0, 0,41, 9], [0,0,0, 0,41,0, 0,0,0, 9], [false, null]);
...
var Redstone = new Block(331, 'Images/Items/Redstone.png', 'tool', null, [0,0, 0,152, 9], [0,0,0, 0,152,0, 0,0,0, 9], [false, null]);
var Lapis = new Block(351.4, 'Images/Items/Lapis.png', 'tool', null, [0,0, 0,22, 9], [0,0,0, 0,22,0, 0,0,0, 9], [false, null]);
var Emerald = new Block(388, 'Images/Items/Emerald.png', 'tool', null, [0,0, 0,129, 9], [0,0,0, 0,129,0, 0,0,0, 9], [false, null]);
